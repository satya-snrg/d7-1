...
<div class="item">
	<div class="item__image">
		<img typeof="foaf:Image" class="image-style-none" src="<?php print file_create_url(drupal_get_path('theme', 'banka_connect_theme') . '/img_apis/' . product_random_image($fields['title']->content)); ?>" alt="" />
	</div>
