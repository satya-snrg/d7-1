  ...
  <div class="mesh-portal-product productWrapper">
    <div class="product">
      ...
      <nav class="toc navigate-toc sticky stickyHeader">
        ...
        <div class="menu-lateral-back">
          <a href="../product" title="">< Regresar a familias</a>
        </div>
          ...
          <section class="documentation navigate-product">
            <div class="documentationContent apicSelfClear">
              <div class="titleHeader">
                ...
                <?php if ($showversions == 1): ?>
                    <span class="version"><?php print $product['info']['version']; ?></span>
                <?php endif; ?>
    ...
    <div class="bottomBorder plansSection navigate-plans">
      <h2 class="plansectiontitle"><?php print t('Planes'); ?></h2>
      <a name="plans"></a>
      <div class="apiList">
      ...
      <div class="plans">
        <div class="plansinner">
          <?php foreach ($product['plans'] as $planName => $plan) : ?>
            ...
            <div class="btnApiSubscribe" style="padding: 10px;">
				<?php if (!user_is_logged_in()) : ?>
				  <span class="planbutton notuser"><button type="button"
														   class="mesh"
														   disabled>
					  <?php print t('Suscribir'); ?></button><?php print t("Login to use this plan"); ?></span>
				<?php elseif (!ibm_apim_check_is_developer()) : ?>
				  <span class="planbutton notdev"><button type="button"
														  class="mesh" disabled>
					  <?php print t('Suscribir'); ?></button><?php print t("Only developers can subscribe to plans"); ?></span>
				<?php else: ?>
				  <?php if (product_check_product_subscribe($node)): ?>
					<button type="button" id="planSignupButton"
							...
							data-title="<?php print t('Suscribir'); ?>"
							data-name="content"
							data-rel="width:500;resizable:false"
							class="mesh simple-dialog my-link-class" style="margin: 0px;"><?php print t('Suscribir'); ?></button>
				  <?php else: ?>
					<?php
					if (isset($product_state[0]['value']) && $product_state[0]['value'] == 'deprecated') {
					...
					<span class="planbutton notsubscribable"><button
						...
						<?php print t('Suscribir'); ?></button><?php print $notsubscribabletext; ?></span>
				  <?php endif; ?>
				<?php endif; ?>
			 </div>
          <?php endforeach; ?>
