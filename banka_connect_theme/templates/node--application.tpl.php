  ...
  <div class="mesh-portal-product">
    <div class="application">
      <nav class="toc navigate-toc sticky stickyHeader">
            ...
            <?php include_once drupal_get_path('theme', 'banka_connect_theme') . '/includes/menu-lateral-user.php'; ?>
        <ul>
          <li
      ...
      <div class="appTitleBar">
        <h1 class="appTitle"><?php print $title; ?></h1>
        <div
          ...
          <?php endif; ?>
          <span class="notificationSettingsApp"><?php print $notificationsettingslink; ?></span>
                    ...
                    <div class="credentialDescriptionRow">
                      ...
                      <div class="credentialActions">
                        <a
                          ...
                          title="<?php print t('Edit'); ?>"><i class="fas fa-edit"></i> 
                        </a>
                        <?php if ($credcount > 1) : ?>
                          <a
                            href="<?php print url("application/" . $application_apiid[0]['value'] . "/delete-clientcreds/" . $cred['id']); ?>"
                            title="<?php print t('Delete'); ?>"><i class="fas fa-times"></i>
                          </a>
                        <?php endif; ?>
                      </div>
                    </div>
                      ...
                      <div class="credentialInfo">
                        ...
                        <div id="app_client_id" class="app_client_id">
                          ...
                          <div class="passwordToggleContainer">
                            ...
                            <label
                              for="show-clientID<?php print $index; ?>"><i class="fas fa-eye"></i></label>
                            <?php $ibm_apim_allow_clientidreset = variable_get('ibm_apim_allow_clientidreset', TRUE); ?>
                            <?php if ($ibm_apim_allow_clientidreset == 1): ?>
                            <a class="buttonLink" href="<?php print url("application/" . $application_apiid[0]['value'] . "/reset-clientid/" . $cred['id']); ?>"><i class="fas fa-sync-alt"></i></a>
                            <?php endif; ?>
                          </div>
                        </div>
                        ...
                        <div class="client_secret">
                          ...
                          <a class="buttonLink"
                             href="<?php print url("application/" . $application_apiid[0]['value'] . "/verify/" . $cred['id']); ?>"><i class="fas fa-check"></i></a>
                          <a class="buttonLink" href="<?php print url("application/" . $application_apiid[0]['value'] . "/reset-secret/" . $cred['id']); ?>"><i class="fas fa-sync-alt"></i></a>
                          <?php endif; ?>
                        </div>
                      </div>
                    </div>
